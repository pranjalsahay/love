...
const style = `
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .photo-real {
    background:linear-gradient(135deg, #ede4f7 0%, #d8c8f0 40%, #e8d8ff 100%);
    display:flex; flex-direction:column; align-items:center; justify-content:center;
    gap:12px; padding:20px;
  }
  .photo-real-emoji { font-size:80px; }
  .photo-real-text { font-family:'Playfair Display',serif; font-style:italic; color:var(--rose); font-size:15px; text-align:center; }
  .photo-upload-note {
    text-align:center; margin-top:36px; padding:22px 30px;
    background:var(--rose-pale); border:1.5px dashed var(--rose-light); border-radius:16px;
    max-width:500px; margin:36px auto 0;
  }
  .photo-upload-note p { font-size:13.5px; color:var(--muted); line-height:1.8; }
  ...
  .playlist-note {
    margin-top:32px; text-align:center; padding:22px; background:var(--rose-pale);
    border-radius:16px; border:1px solid rgba(201,184,232,0.5);
  }
  ...
  .wish-card {
    ...
    box-shadow:0 6px 28px rgba(124,92,191,0.07);
...
const LoginScreen = ({ onLogin }) => {
  ...
  return (
    <div className="login-wrap">
      ...
      <div className="login-card" style={shaking ? { animation: "fadeUp 0.9s ease both, borderPulse 3s ease-in-out 1.2s infinite, shake 0.4s ease" } : {}}>
        ...
        <div className="field-wrap">
          ...
          <input className="field-input" value={name} onChange={e => setName(e.target.value)}
            placeholder="Enter your name…" onKeyDown={e => e.key === "Enter" && attempt()} />
        </div>
        <div className="field-wrap">
      ...
      <div className={`page ${page === "photos" ? "active" : ""}`}>
        <section className="section photos-bg">
          ...
          <div className="photo-grid">
            {/* Featured first photo spanning 2 columns */}
      ...
      <div className={`page ${page === "playlist" ? "active" : ""}`}>
        <section className="section playlist-bg">
          ...
          <div className="playlist-wrap">
            {songs.map((s, i) => (
              <div className={`playlist-card ${playingIdx === i ? "playing" : ""}`} key={i}
        ...
        <section className="section wish-bg">
          <div className="wish-wrap">
            ...
            <div className="wish-message">
              ...
              {!wishSent ? (
                <>
                  <textarea className="wish-input-area" rows={4}
                ...
                <div style={{ marginTop: 24 }}>
                  ...
                  <button className="wish-submit" style={{ marginTop: 20 }}
